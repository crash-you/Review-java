...
/*  现在有两个ArrayList集合，分别存储6名男演员的名字和年龄以及6名女演员的名字和年龄。姓名和年龄中间用逗号隔开。
        ...
        要求完成如下的操作:
           ...
           5,将所有的演员对象都保存到List集合中。备注:演员类Actor，属性有: name.age
                男演员:"蔡坤坤,24”，"叶躺咸,23""，"刘不甜,22""，"吴签,24"，"谷嘉,30"，"肖梁梁,27"
    ...
    public static void main(String[] args) {
        ...
        Collections.addAll(manList,"蔡坤坤,24","叶躺咸,23","刘不甜,22","吴签,24","谷嘉,30","肖梁梁,27");
       ...
       Stream.concat(stream1,stream2).map(new Function<String, Actor>() {
        ...
        List<Actor> list = Stream.concat(stream1, stream2)
                ...
                .collect(Collectors.toList());//相当于创建一个arraylist集合，并且把流里的数据存到集合里
